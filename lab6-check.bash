...
check "ssh ${deb1UserName}@deb1 grep -isq 192.168.245.11 '/etc/network/interfaces'" "This program could find a correct address in the network interface file. Please make fixes, and re-run this checking shell script." | tee -a $logfile
